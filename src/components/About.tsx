            ...
            <div className="flex animate-marquee gap-8 items-center whitespace-nowrap">
              ...
              {(() => {
                const list = [
                  ...
                  { name: 'React', icon: <img className="w-5 h-5 object-contain" src="https://img.icons8.com/?size=100&id=asWSSTBrDlTW&format=png&color=0000000" alt="React" /> },
                  { name: 'Next.js', icon: <img className="w-5 h-5 object-contain" src="https://img.icons8.com/?size=100&id=r2OarXWQc7B6&format=png&color=000000" alt="Next.js" /> },
                  { name: 'Tailwind CSS', icon: <img className="w-5 h-5 object-contain" src="https://img.icons8.com/?size=100&id=CIAZz2CYc6Kc&format=png&color=000000" alt="Tailwindcss" /> },
